...
function buildTypeContext(invoice: EnrichedInvoice): string {
  if (invoice.type === "deposit") {
    if (invoice.depositType === "percentage") return `${invoice.depositPercentage}% deposit on accepted quotation`;
            ...
            <Card className="md:col-span-1">
              <CardContent className="pt-4 pb-4">
                ...
                <div className="space-y-2.5">
                  ...
                  {!invoice.quoteId && !invoice.jobName && !invoice.divisionCode && (
                    <p className="text-xs text-muted-foreground italic">No linkage</p>
                  )}
                </div>
              </CardContent>
            </Card>
