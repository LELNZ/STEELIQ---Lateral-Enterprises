...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/ll-pricing-profiles">{() => { window.location.replace("/settings?division=LL&tab=pricing-model"); return null; }}</Route>
      <Route path="/ll-commercial-inputs">{() => { window.location.replace("/settings?division=LL&tab=source-costs"); return null; }}</Route>
