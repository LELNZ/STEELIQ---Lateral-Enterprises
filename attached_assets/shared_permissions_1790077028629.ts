...
// Existing users already carry role "estimator" (the current default) or "admin".
// Treat "estimator" as an alias for "qs" so nobody's access silently changes the
// moment this ships — rename the stored values in a later, explicit migration if
// you want the DB to say "qs" directly.
