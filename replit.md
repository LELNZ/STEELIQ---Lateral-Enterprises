...
**CRM Workflow**: Project-centric CRM with automatic customer linking from quotes, project creation linked to quotes, and sub-query endpoints. Projects have persisted `projectNumber` (PRJ-XXXX format) auto-assigned via server-side sequence on creation.
