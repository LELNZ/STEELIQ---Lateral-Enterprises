...
**Invoice Detail Page**: Dedicated `/invoices/:id` route with full invoice detail view including editable description, notes, and reference fields. Status actions (mark ready, push to Xero, approve, return to draft) available in the header. Invoice numbers in the global list are clickable links to the detail page.
