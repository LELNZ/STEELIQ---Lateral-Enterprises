...
**Invoice Allocation Control**: Prevents over-invoicing with deposit caps (50% of accepted value) and contract value caps (total invoices not exceeding accepted value). Provides a detailed invoice allocation state via API.
