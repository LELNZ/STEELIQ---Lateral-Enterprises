...
## Current Milestone
Default Tuning Pass (T090–T095) complete. Template Builder v1.3 (T083–T089) complete. Company Master Template v2 (T077–T082) complete.
- **Default Tuning Pass (T090–T095)**: Company master template defaults tuned for stronger out-of-box professional output. T090: header defaults — `logoWidthMm=70`, `logoMaxHeightMm=26`, `contactBlockAlignment=compact_right`, `headerBottomSpacingMm=5`, `showTradingName=false`, `legalLinePlacement=under_logo`. Logo scale "large" preset synced to 70×26mm. T091: schedule density defaults — `drawingMaxH=40`, `specRowH=3.3`, `itemHeaderH=9`, `photoRowH=18`, `itemCardPadMm=2.8`, `itemGapMm=2.8`. Standard density preset updated to match. Compact preset tightened (`specRowH=2.8`, `photoRowH=14`). T092: visual hierarchy — default `photoMaxSizeMm=20` (was 25), photo presets recalibrated (15/20/35mm), drawings prioritized over photos. T093: validated against representative quotes in both Preview and PDF. T094: builder select fallbacks updated to use `COMPANY_MASTER_TEMPLATE` constants for contact block alignment. T095: tightly scoped — defaults only, no new controls or systems. Architecture guards preserved.
